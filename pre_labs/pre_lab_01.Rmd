...
**Answer** 54247 rows and 24 variables
...
**Answer** The code is stating how many contributions were made on particular dates.
...
**Answer** This codeblock appears to have counted the total number of contributions overall on a particular date.
...
Compared to the previous codeblock, what has changed and how did that affect the result?
**Answer** This codeblock gathered the contributions that were earmarked for specific committee
...
```
Compared to the previous codeblock, what has changed and how did that affect the result?
**Answer** I think the difference is that this codeblock lists the contributions in numerical order
...
**Answer** This data is sorted out by location.

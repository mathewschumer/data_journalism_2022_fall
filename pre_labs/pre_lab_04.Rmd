...
**Answer** 24 are present; there COULD be 25, including the total
...
**Answer** It says that there is a problem, but it does not elaborate on what the problem is.
...
**Answer** The answer I got was Prince George's County.
...
**Answer** I noticed that the data provided lower percentages, as well as a different top county, being Howard County.
...
**Answer** The data type is numeric, when it should be character datatype, given the fact that it is qualitative data.
...
**Answer** Datatype was changed to character

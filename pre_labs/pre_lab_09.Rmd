...
**Answer** The columns in this data all have something to do with the geographic characteristics of the data. These columns include identifiers that describe the name and jurisdictions in which the entries reside, as well as the shape of the area and the length/area.
...
**Answer** The data included in this set describes the geographic makeup of each precinct.
...
**Answer** This appears to be a map of all election precincts in Prince George's County, MD.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This is a plot of all county information in the United States in 2020.
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This filtered the data from the previous codeblock to present only counties in MD.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This creates a map of all counties in MD.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This is a precinct map of Prince George's County.
...
**Task** Run the following code. Describe the output in the space below.
**Answer** This code creates a list of precinct totals in PG County for the 2022 primaries.
...
**Task** Run the following code. Describe the output in the space below.
**Answer** This code joins the precinct totals list with the precinct map dataset.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This code creates a map that visualizes which data has the most eligible voters, utilizing shades of blue to correspond with the totals.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This code creates a dataset displaying the total elifgible voters in each MD county.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This code creates a dataset containing the total population of each county in MD.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This code creates a dataset of geographical data of each county in MD.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This displays the datasets mentioned above.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This codeblock removed instances of "Maryland" and "County" so the column names can match.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This code joins the datasets.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This code fixes the remaining discrepancies between the datasets.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This code rejoins the datasets and creates a new column of voters per capita, before arranging based on this column.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This code creates a similar map that displays the counties in MD with shades of blue corresponding with their voters per 10 thousand.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This code changes the color scale of the map to "Magma."
...
**Answer** This code introduces "log," which changes the color scale to make each shade more visible. I saw that the areas with the most affiliated voters per capita were the more affluent counties.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This code creates a dataset similar to the one before, but this time with unaffiliated voters.
...
**Answer** This code creates the same map as above, but this time with unaffiliated voters as the dataset. I found that the data correlated somewhat with the overall population density of each county.

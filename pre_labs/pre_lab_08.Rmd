...
**Answer** First row is setting the name for the new dataset, before arranging the data by the TOTAL_DIFF coulmn, then selecting only the two columns: County and TOTAL_DIFF. The code then only decides to present the top ten counties.
...
**Answer** This code creates a blank canvas plot.
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** This code now presents the information in the form of a bar chart and sets the parameters of the x and y axis
...
**Answer** This plot reorders the x axis to be ascending in y value.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** This codeblock switches information in the x and y axis.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** This code utilizes a "minimal" theme to get rid of the grey background.
...
**Answer** This codeblock changes the theme to the "economist" theme, that has a blue background and a line running through the bars with no real grid.
```{r}
maryland_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(County,TOTAL_DIFF), weight=TOTAL_DIFF)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** This codeblock adds a title, changes the name of the plot, then adds a caption that cites the source of the plot.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** I see the amount contributed to WinRed every day from April to the end of June.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** After running this codeblock, I see a line graph depicting the data in the tibble above.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** This codeblock sets data points for the beginning/end of each week and the format for the date names.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** This code simply tilts the names of the dates in the x axis 45 degrees.
```{r}
md_winred_by_date %>%
  ggplot() + 
  geom_line(aes(x=date, y=total_contributions)) + 

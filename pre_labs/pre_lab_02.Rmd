...
**Answer** This code is creating a new column based off the data in other columns.
...
**Answer** This code took the same table and ordered it in descending order based on the present_election_data column.
...
**Answer** Yes, this answer illustrates which races had the lowest percentages of election day votes.
...
**Answer** str_to_lower makes the title lowercase, and str_to_title converts to first letter capitalized.
...
**Answer** Largest category is the >2900 category, which also has the lowest number of entries.
...
**Answer** Not sure which variable is "new" as it appears all other have showed up before.
...
**Answer:** Expenditure date became formalized to present as year, month, day
...
**Answer** The values in the new month column illustrate that the values in the next column are indicative of the totals as of the first day of each month.

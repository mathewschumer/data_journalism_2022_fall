...
**Answer** This code outputs the press releases and the chosen metadata, such as the date, link, etc.
...
**Answer** This code shows the unique word entries in the list of words.
...
**Answer** This code outputs the unique words in the press releases, as well as using unnest_tokens to standardize the capitalization and punctuation as null. 
...
**Answer** This code creates a vertical bar chart displaying the top 25 used words in the press releases and presents them in descending order.
...
**Answer** This code displays the most used words in the press releases after implementing the stop words function in a tibble of descending order.
...
**Answer** This code creates two tibbles each presenting the top 10 used words (barring stop words) from 2021 and 2022 respectively.
...
**Task** Run the following code and describe the results.
**Answer** This code filters the releases before 2022 and lists the 10 most frequently used terms in that date frame, along with the total number of instances and percent usage of total word usage in the date frame.
...
**Task** Run the following code and describe the results.
**Answer** This code filters the releases in 2022 and lists the 10 most frequently used terms in that date frame, along with the total number of instances and percent usage of total word usage in the date frame.

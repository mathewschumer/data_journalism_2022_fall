...
**Answer** https://datawrapper.dwcdn.net/1nieQ/1/
...
write_csv(new_md_gov_county, "data/md_gov_county.csv")
```
...
**Answer** This map is only of MD, whereas the previous map showed the entire nation.
...
**Answer** The tooltips now present the name of each county and the percentage of the vote recieved by Moore in that county.
...
**Answer** https://datawrapper.dwcdn.net/Ahl6R/1/

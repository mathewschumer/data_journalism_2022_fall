...
**Answer** Warning: One or more parsing issues, see `problems()` for detailsRows: 195865 Columns: 63── Column specification
...
**Answer** It doesn't look like there are any errors
...
**Answer** Name and ID is qualitative, while the amount column is quantitative
```{r}
...
It looks like this codeblock sorts the data by ID
...
**Answer** Two of these rows share the same name, amount, ID, and street address.
...
**Answer** This function makes the first column present the contribution amount.
...
**Answer** Error says there was a problem while computing the total amount, probably meaning that some of the amounts were entered improperly.
...
**Answer** It appears that this function formalizes the entries in the zip code column.

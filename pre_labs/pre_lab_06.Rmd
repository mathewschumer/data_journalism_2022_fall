...
```{r}
voters_by_county <- read_csv("data/county_voters.csv")
...
**Answer** There is an empty jurisdiction row and BEND is still its own row, when it should be part of the previous row.
...
**Answer** This dataframe filters out the extraneaous rows, in which the "cast" votes are N/A.

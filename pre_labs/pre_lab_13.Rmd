...
**Answer** All of the columns are character columns and contain bottom rows that display column totals and percentages of the full data.
...
**Answer** The numbers dictate which number column the name is classifying, based on a left to right model.
...
**Answer** There are 57 lines/rows in the source's unordered list.
...
**Answer** This code filters and extracts li tags from the source and turns them in to lines and strips away the rest of the code.
...
**Answer** This codeblock takes the lines from the previous dataframe and turns it into a tibble.
